...
`;
const Card = styled.a`
  ${tw`flex flex-col items-center justify-center text-center bg-white rounded-lg shadow-md p-4 transition-transform duration-300 hover:cursor-pointer hover:scale-[105%]`}
