...
export const Container = tw.div`relative bg-white rounded-xl shadow-md mt-5`;
export const ContentWithPaddingXl= tw.div`max-w-screen-xl mx-auto py-12 lg:py-24`;
